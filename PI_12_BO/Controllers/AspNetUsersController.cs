...
namespace PI_12_BO.Controllers
{
    ...
    public class AspNetUsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Email,EmailConfirmed,PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName,BirthDate,Gender,FullName")] AspNetUsers aspNetUsers)
        {
            if (ModelState.IsValid)
            {
